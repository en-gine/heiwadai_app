...
class SetNewPasswordRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetNewPasswordRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.admin'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessToken', protoName: 'accessToken')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'password')
    ..hasRequiredFields = false
  ;

  SetNewPasswordRequest._() : super();
  factory SetNewPasswordRequest({
    $core.String? accessToken,
    $core.String? password,
  }) {
    final _result = create();
  ...
  factory SetNewPasswordRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetNewPasswordRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SetNewPasswordRequest clone() => SetNewPasswordRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetNewPasswordRequest copyWith(void Function(SetNewPasswordRequest) updates) => super.copyWith((message) => updates(message as SetNewPasswordRequest)) as SetNewPasswordRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SetNewPasswordRequest create() => SetNewPasswordRequest._();
  SetNewPasswordRequest createEmptyInstance() => create();
  static $pb.PbList<SetNewPasswordRequest> createRepeated() => $pb.PbList<SetNewPasswordRequest>();
  @$core.pragma('dart2js:noInline')
  static SetNewPasswordRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetNewPasswordRequest>(create);
  static SetNewPasswordRequest? _defaultInstance;
