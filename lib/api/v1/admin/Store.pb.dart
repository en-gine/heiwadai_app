...
class StoreIDRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StoreIDRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.admin'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ID', protoName: 'ID')
    ..hasRequiredFields = false
  ;
...
class QRResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QRResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.admin'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'QRCode', protoName: 'QRCode')
    ..hasRequiredFields = false
  ;
  ...
  factory QRResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QRResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QRResponse clone() => QRResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QRResponse copyWith(void Function(QRResponse) updates) => super.copyWith((message) => updates(message as QRResponse)) as QRResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QRResponse create() => QRResponse._();
  QRResponse createEmptyInstance() => create();
  static $pb.PbList<QRResponse> createRepeated() => $pb.PbList<QRResponse>();
  @$core.pragma('dart2js:noInline')
  static QRResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QRResponse>(create);
  static QRResponse? _defaultInstance;
...
class UnlimitQRResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UnlimitQRResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.admin'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'UnlimitQRCode', protoName: 'UnlimitQRCode')
    ..hasRequiredFields = false
  ;

  UnlimitQRResponse._() : super();
  factory UnlimitQRResponse({
    $core.String? unlimitQRCode,
  }) {
    final _result = create();
    if (unlimitQRCode != null) {
      _result.unlimitQRCode = unlimitQRCode;
    }
    return _result;
  }
  factory UnlimitQRResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UnlimitQRResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UnlimitQRResponse clone() => UnlimitQRResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UnlimitQRResponse copyWith(void Function(UnlimitQRResponse) updates) => super.copyWith((message) => updates(message as UnlimitQRResponse)) as UnlimitQRResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UnlimitQRResponse create() => UnlimitQRResponse._();
  UnlimitQRResponse createEmptyInstance() => create();
  static $pb.PbList<UnlimitQRResponse> createRepeated() => $pb.PbList<UnlimitQRResponse>();
  @$core.pragma('dart2js:noInline')
  static UnlimitQRResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UnlimitQRResponse>(create);
  static UnlimitQRResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get unlimitQRCode => $_getSZ(0);
  @$pb.TagNumber(1)
  set unlimitQRCode($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasUnlimitQRCode() => $_has(0);
  @$pb.TagNumber(1)
  void clearUnlimitQRCode() => clearField(1);
}
