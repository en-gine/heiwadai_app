...
class UserRegisterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserRegisterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.user'), createEmptyInstance: create)
    ...
    ..aOM<$25.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'BirthDate', protoName: 'BirthDate', subBuilder: $25.Timestamp.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ZipCode', protoName: 'ZipCode')
    ..e<$26.Prefecture>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Prefecture', $pb.PbFieldType.OE, protoName: 'Prefecture', defaultOrMaker: $26.Prefecture.Unspecified, valueOf: $26.Prefecture.valueOf, enumValues: $26.Prefecture.values)
  ...
  @$pb.TagNumber(6)
  $25.Timestamp get birthDate => $_getN(5);
  @$pb.TagNumber(6)
  set birthDate($25.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasBirthDate() => $_has(5);
  @$pb.TagNumber(6)
  void clearBirthDate() => clearField(6);
  @$pb.TagNumber(6)
  $25.Timestamp ensureBirthDate() => $_ensure(5);
  ...
  @$pb.TagNumber(8)
  $26.Prefecture get prefecture => $_getN(7);
  @$pb.TagNumber(8)
  set prefecture($26.Prefecture v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class UserUpdateDataRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserUpdateDataRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.user'), createEmptyInstance: create)
    ...
    ..aOM<$25.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'BirthDate', protoName: 'BirthDate', subBuilder: $25.Timestamp.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ZipCode', protoName: 'ZipCode')
    ..e<$26.Prefecture>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Prefecture', $pb.PbFieldType.OE, protoName: 'Prefecture', defaultOrMaker: $26.Prefecture.Unspecified, valueOf: $26.Prefecture.valueOf, enumValues: $26.Prefecture.values)
  ...
  @$pb.TagNumber(7)
  $25.Timestamp get birthDate => $_getN(6);
  @$pb.TagNumber(7)
  set birthDate($25.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasBirthDate() => $_has(6);
  @$pb.TagNumber(7)
  void clearBirthDate() => clearField(7);
  @$pb.TagNumber(7)
  $25.Timestamp ensureBirthDate() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $26.Prefecture get prefecture => $_getN(8);
  @$pb.TagNumber(9)
  set prefecture($26.Prefecture v) { setField(9, v); }
  @$pb.TagNumber(9)
