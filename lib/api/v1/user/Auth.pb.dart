...
class UserAuthTokenResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserAuthTokenResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.user'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessToken', protoName: 'accessToken')
  ...
  UserAuthTokenResponse._() : super();
  factory UserAuthTokenResponse({
    $core.String? accessToken,
  ...
  factory UserAuthTokenResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UserAuthTokenResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UserAuthTokenResponse clone() => UserAuthTokenResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserAuthTokenResponse copyWith(void Function(UserAuthTokenResponse) updates) => super.copyWith((message) => updates(message as UserAuthTokenResponse)) as UserAuthTokenResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UserAuthTokenResponse create() => UserAuthTokenResponse._();
  UserAuthTokenResponse createEmptyInstance() => create();
  static $pb.PbList<UserAuthTokenResponse> createRepeated() => $pb.PbList<UserAuthTokenResponse>();
  @$core.pragma('dart2js:noInline')
  static UserAuthTokenResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserAuthTokenResponse>(create);
  static UserAuthTokenResponse? _defaultInstance;
