...
class BookResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BookResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.user'), createEmptyInstance: create)
    ...
    ..aOM<$21.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'StayFrom', protoName: 'StayFrom', subBuilder: $21.Timestamp.create)
    ..aOM<$21.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'StayTo', protoName: 'StayTo', subBuilder: $21.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $21.Timestamp get stayFrom => $_getN(1);
  @$pb.TagNumber(2)
  set stayFrom($21.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStayFrom() => $_has(1);
  @$pb.TagNumber(2)
  void clearStayFrom() => clearField(2);
  @$pb.TagNumber(2)
  $21.Timestamp ensureStayFrom() => $_ensure(1);

  @$pb.TagNumber(3)
  $21.Timestamp get stayTo => $_getN(2);
  @$pb.TagNumber(3)
  set stayTo($21.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStayTo() => $_has(2);
  @$pb.TagNumber(3)
  void clearStayTo() => clearField(3);
  @$pb.TagNumber(3)
  $21.Timestamp ensureStayTo() => $_ensure(2);
...
class GuestData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GuestData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.user'), createEmptyInstance: create)
    ...
    ..e<$23.Prefecture>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Prefecture', $pb.PbFieldType.OE, protoName: 'Prefecture', defaultOrMaker: $23.Prefecture.Unspecified, valueOf: $23.Prefecture.valueOf, enumValues: $23.Prefecture.values)
  ...
  @$pb.TagNumber(7)
  $23.Prefecture get prefecture => $_getN(6);
  @$pb.TagNumber(7)
  set prefecture($23.Prefecture v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class ReserveRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReserveRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.user'), createEmptyInstance: create)
    ..aOM<$21.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'StayFrom', protoName: 'StayFrom', subBuilder: $21.Timestamp.create)
    ..aOM<$21.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'StayTo', protoName: 'StayTo', subBuilder: $21.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $21.Timestamp get stayFrom => $_getN(0);
  @$pb.TagNumber(1)
  set stayFrom($21.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStayFrom() => $_has(0);
  @$pb.TagNumber(1)
  void clearStayFrom() => clearField(1);
  @$pb.TagNumber(1)
  $21.Timestamp ensureStayFrom() => $_ensure(0);

  @$pb.TagNumber(2)
  $21.Timestamp get stayTo => $_getN(1);
  @$pb.TagNumber(2)
  set stayTo($21.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStayTo() => $_has(1);
  @$pb.TagNumber(2)
  void clearStayTo() => clearField(2);
  @$pb.TagNumber(2)
  $21.Timestamp ensureStayTo() => $_ensure(1);
