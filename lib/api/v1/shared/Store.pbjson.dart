...
const Store$json = const {
  ...
  '2': const [
    ...
    const {'1': 'StayableStoreInfo', '3': 13, '4': 1, '5': 11, '6': '.server.shared.StayableStoreInfo', '9': 1, '10': 'StayableStoreInfo', '17': true},
  ],
  '8': const [
    const {'1': '_BranchName'},
    const {'1': '_StayableStoreInfo'},
  ],
};

/// Descriptor for `Store`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List storeDescriptor = $convert.base64Decode('');
...
const StayableStore$json = const {
  ...
  '2': const [
    ...
    const {'1': 'Info', '3': 2, '4': 1, '5': 11, '6': '.server.shared.StayableStoreInfo', '9': 0, '10': 'Info', '17': true},
  ],
  '8': const [
    const {'1': '_Info'},
  ],
...
final $typed_data.Uint8List stayableStoreDescriptor = $convert.base64Decode('Cg1TdGF5YWJsZVN0b3JlEioKBVN0b3JlGAEgASgLMhQuc2VydmVyLnNoYXJlZC5TdG9yZVIFU3RvcmUSOQoESW5mbxgCIAEoCzIgLnNlcnZlci5zaGFyZWQuU3RheWFibGVTdG9yZUluZm9IAFIESW5mb4gBAUIHCgVfSW5mbw==');
