...
class Store extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Store', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'server.shared'), createEmptyInstance: create)
    ...
    ..aOM<StayableStoreInfo>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'StayableStoreInfo', protoName: 'StayableStoreInfo', subBuilder: StayableStoreInfo.create)
  ...
  factory Store({
    ...
    if (stayableStoreInfo != null) {
      _result.stayableStoreInfo = stayableStoreInfo;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(13)
  StayableStoreInfo get stayableStoreInfo => $_getN(12);
  @$pb.TagNumber(13)
  set stayableStoreInfo(StayableStoreInfo v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasStayableStoreInfo() => $_has(12);
  @$pb.TagNumber(13)
  void clearStayableStoreInfo() => clearField(13);
  @$pb.TagNumber(13)
  StayableStoreInfo ensureStayableStoreInfo() => $_ensure(12);
}
